...
class Steam: public Object {
	...
	public:
		...
		enum InputActionOrigin {
			...
			INPUT_ACTION_ORIGIN_XBOX_360_RESERVED10 = 191, INPUT_ACTION_ORIGIN_SWITCH_A = 192, INPUT_ACTION_ORIGIN_SWITCH_B = 193, INPUT_ACTION_ORIGIN_SWITCH_X = 194, INPUT_ACTION_ORIGIN_SWITCH_Y = 195, INPUT_ACTION_ORIGIN_SWITCH_LEFT_BUMPER = 196, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_BUMPER = 197, INPUT_ACTION_ORIGIN_SWITCH_PLUS = 198, INPUT_ACTION_ORIGIN_SWITCH_MINUS = 199, 
			INPUT_ACTION_ORIGIN_SWITCH_CAPTURE = 200, INPUT_ACTION_ORIGIN_SWITCH_LEFT_TRIGGER_PULL = 201, INPUT_ACTION_ORIGIN_SWITCH_LEFT_TRIGGER_CLICK = 202, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_TRIGGER_PULL = 203, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_TRIGGER_CLICK = 204, INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_MOVE = 205, INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_CLICK = 206,
			INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_DPAD_NORTH = 207, INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_DPAD_SOUTH = 208, INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_DPAD_WEST = 209, INPUT_ACTION_ORIGIN_SWITCH_LEFT_STICK_DPAD_EAST = 210, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_MOVE = 211, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_CLICK = 212,
			INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_DPAD_NORTH = 213, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_DPAD_SOUTH = 214, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_DPAD_WEST = 215, INPUT_ACTION_ORIGIN_SWITCH_RIGHT_STICK_DPAD_EAST = 216, INPUT_ACTION_ORIGIN_SWITCH_DPAD_NORTH = 217, INPUT_ACTION_ORIGIN_SWITCH_DPAD_SOUTH = 218, INPUT_ACTION_ORIGIN_SWITCH_DPAD_WEST = 219, 
			INPUT_ACTION_ORIGIN_SWITCH_DPAD_EAST = 220, INPUT_ACTION_ORIGIN_SWITCH_PRO_GYRO_MOVE = 221, INPUT_ACTION_ORIGIN_SWITCH_PRO_GYRO_PITCH = 222, INPUT_ACTION_ORIGIN_SWITCH_PRO_GYRO_YAW = 223, INPUT_ACTION_ORIGIN_SWITCH_PRO_GYRO_ROLL = 224, INPUT_ACTION_ORIGIN_SWITCH_RESERVED0 = 225, INPUT_ACTION_ORIGIN_SWITCH_RESERVED1 = 226,
			INPUT_ACTION_ORIGIN_SWITCH_RESERVED2 = 227, INPUT_ACTION_ORIGIN_SWITCH_RESERVED3 = 228, INPUT_ACTION_ORIGIN_SWITCH_RESERVED4 = 229, INPUT_ACTION_ORIGIN_SWITCH_RESERVED5 = 230, INPUT_ACTION_ORIGIN_SWITCH_RESERVED6 = 231, INPUT_ACTION_ORIGIN_SWITCH_RESERVED7 = 232, INPUT_ACTION_ORIGIN_SWITCH_RESERVED8 = 233, INPUT_ACTION_ORIGIN_SWITCH_RESERVED9 = 234,
			INPUT_ACTION_ORIGIN_SWITCH_RESERVED10 = 235, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGYRO_MOVE = 236, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGYRO_PITCH = 237, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGYRO_YAW = 238, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGYRO_ROLL = 239, INPUT_ACTION_ORIGIN_SWITCH_LEFTGYRO_MOVE = 240, INPUT_ACTION_ORIGIN_SWITCH_LEFTGYRO_PITCH = 241,
			INPUT_ACTION_ORIGIN_SWITCH_LEFTGYRO_YAW = 242, INPUT_ACTION_ORIGIN_SWITCH_LEFTGYRO_ROLL = 243, INPUT_ACTION_ORIGIN_SWITCH_LEFTGRIP_LOWER = 244, INPUT_ACTION_ORIGIN_SWITCH_LEFTGRIP_UPPER = 245, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGRIP_LOWER = 246, INPUT_ACTION_ORIGIN_SWITCH_RIGHTGRIP_UPPER = 247, INPUT_ACTION_ORIGIN_SWITCH_JOYCON_BUTTON_N = 248,
			INPUT_ACTION_ORIGIN_SWITCH_JOYCON_BUTTON_E = 249, INPUT_ACTION_ORIGIN_SWITCH_JOYCON_BUTTON_S = 250, INPUT_ACTION_ORIGIN_SWITCH_JOYCON_BUTTON_W = 251, INPUT_ACTION_ORIGIN_SWITCH_RESERVED15 = 252, INPUT_ACTION_ORIGIN_SWITCH_RESERVED16 = 253, INPUT_ACTION_ORIGIN_SWITCH_RESERVED17 = 254, INPUT_ACTION_ORIGIN_SWITCH_RESERVED18 = 255,
			INPUT_ACTION_ORIGIN_SWITCH_RESERVED19 = 256, INPUT_ACTION_ORIGIN_SWITCH_RESERVED20 = 257, INPUT_ACTION_ORIGIN_PS5_X = 258, INPUT_ACTION_ORIGIN_PS5_CIRCLE = 259, INPUT_ACTION_ORIGIN_PS5_TRIANGLE = 260, INPUT_ACTION_ORIGIN_PS5_SQUARE = 261, INPUT_ACTION_ORIGIN_PS5_LEFTBUMPER = 262, INPUT_ACTION_ORIGIN_PS5_RIGHTBUMPER = 263, INPUT_ACTION_ORIGIN_PS5_OPTION = 264, 
			INPUT_ACTION_ORIGIN_PS5_CREATE = 265, INPUT_ACTION_ORIGIN_PS5_MUTE = 266, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_TOUCH = 267, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_SWIPE = 268, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_CLICK = 269, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_DPADNORTH = 270, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_DPADSOUTH = 271, INPUT_ACTION_ORIGIN_PS5_LEFTPAD_DPADWEST = 272, 
			INPUT_ACTION_ORIGIN_PS5_LEFTPAD_DPADEAST = 273, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_TOUCH = 274, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_SWIPE = 275, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_CLICK = 276, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_DPADNORTH = 277, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_DPADSOUTH = 278, INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_DPADWEST = 279,
			INPUT_ACTION_ORIGIN_PS5_RIGHTPAD_DPADEAST = 280, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_TOUCH = 281, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_SWIPE = 282, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_CLICK = 283, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_DPADNORTH = 284, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_DPADSOUTH = 285, INPUT_ACTION_ORIGIN_PS5_CENTERPAD_DPADWEST = 286,
			INPUT_ACTION_ORIGIN_PS5_CENTERPAD_DPADEAST = 287, INPUT_ACTION_ORIGIN_PS5_LEFTTRIGGER_PULL = 288, INPUT_ACTION_ORIGIN_PS5_LEFTTRIGGER_CLICK = 289, INPUT_ACTION_ORIGIN_PS5_RIGHTTRIGGER_PULL = 290, INPUT_ACTION_ORIGIN_PS5_RIGHTTRIGGER_CLICK = 291, INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_MOVE = 292, INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_CLICK = 293,
			INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_DPADNORTH = 294, INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_DPADSOUTH = 295, INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_DPADWEST = 296, INPUT_ACTION_ORIGIN_PS5_LEFTSTICK_DPADEAST = 297, INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_MOVE = 298, INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_CLICK = 299, INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_DPADNORTH = 300,
			INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_DPADSOUTH = 301, INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_DPADWEST = 302, INPUT_ACTION_ORIGIN_PS5_RIGHTSTICK_DPADEAST = 303, INPUT_ACTION_ORIGIN_PS5_DPAD_NORTH = 304, INPUT_ACTION_ORIGIN_PS5_DPAD_SOUTH = 305, INPUT_ACTION_ORIGIN_PS5_DPAD_WEST = 306, INPUT_ACTION_ORIGIN_PS5_DPAD_EAST = 307, INPUT_ACTION_ORIGIN_PS5_GYRO_MOVE = 308,
			INPUT_ACTION_ORIGIN_PS5_GYRO_PITCH = 309, INPUT_ACTION_ORIGIN_PS5_GYRO_YAW = 310, INPUT_ACTION_ORIGIN_PS5_GYRO_ROLL = 311, INPUT_ACTION_ORIGIN_PS5_DPAD_MOVE = 312, INPUT_ACTION_ORIGIN_PS5_LEFTGRIP = 313, INPUT_ACTION_ORIGIN_PS5_RIGHTGRIP = 314, INPUT_ACTION_ORIGIN_PS5_LEFTFN = 315, INPUT_ACTION_ORIGIN_PS5_RIGHTFN = 316, INPUT_ACTION_ORIGIN_PS5_RESERVED5 = 317,
			INPUT_ACTION_ORIGIN_PS5_RESERVED6 = 318, INPUT_ACTION_ORIGIN_PS5_RESERVED7 = 319, INPUT_ACTION_ORIGIN_PS5_RESERVED8 = 320, INPUT_ACTION_ORIGIN_PS5_RESERVED9 = 321, INPUT_ACTION_ORIGIN_PS5_RESERVED10 = 322, INPUT_ACTION_ORIGIN_PS5_RESERVED11 = 323, INPUT_ACTION_ORIGIN_PS5_RESERVED12 = 324, INPUT_ACTION_ORIGIN_PS5_RESERVED13 = 325,
			INPUT_ACTION_ORIGIN_PS5_RESERVED14 = 326, INPUT_ACTION_ORIGIN_PS5_RESERVED15 = 327, INPUT_ACTION_ORIGIN_PS5_RESERVED16 = 328, INPUT_ACTION_ORIGIN_PS5_RESERVED17 = 329, INPUT_ACTION_ORIGIN_PS5_RESERVED18 = 330, INPUT_ACTION_ORIGIN_PS5_RESERVED19 = 331, INPUT_ACTION_ORIGIN_PS5_RESERVED20 = 332, INPUT_ACTION_ORIGIN_STEAMDECK_A = 333,
			INPUT_ACTION_ORIGIN_STEAMDECK_B = 334, INPUT_ACTION_ORIGIN_STEAMDECK_X = 335, INPUT_ACTION_ORIGIN_STEAMDECK_Y = 336, INPUT_ACTION_ORIGIN_STEAMDECK_L1 = 337, INPUT_ACTION_ORIGIN_STEAMDECK_R1 = 338, INPUT_ACTION_ORIGIN_STEAMDECK_MENU = 339, INPUT_ACTION_ORIGIN_STEAMDECK_VIEW = 340, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_TOUCH = 341,
			INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_SWIPE = 342, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_CLICK = 343, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_DPADNORTH = 344, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_DPADSOUTH = 345, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_DPADWEST = 346, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTPAD_DPADEAST = 347,
			INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_TOUCH = 348, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_SWIPE = 349, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_CLICK = 350, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_DPADNORTH = 351, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_DPADSOUTH = 352, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_DPADWEST = 353,
			INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTPAD_DPADEAST = 354, INPUT_ACTION_ORIGIN_STEAMDECK_L2_SOFTPULL = 355, INPUT_ACTION_ORIGIN_STEAMDECK_L2 = 356, INPUT_ACTION_ORIGIN_STEAMDECK_R2_SOFTPULL = 357, INPUT_ACTION_ORIGIN_STEAMDECK_R2 = 358, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_MOVE = 359, INPUT_ACTION_ORIGIN_STEAMDECK_L3 = 360,
			INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_DPADNORTH = 361, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_DPADSOUTH = 362, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_DPADWEST = 363, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_DPADEAST = 364, INPUT_ACTION_ORIGIN_STEAMDECK_LEFTSTICK_TOUCH = 365, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_MOVE = 366,
			INPUT_ACTION_ORIGIN_STEAMDECK_R3 = 367, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_DPADNORTH = 368, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_DPADSOUTH = 369, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_DPADWEST = 370, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_DPADEAST = 371, INPUT_ACTION_ORIGIN_STEAMDECK_RIGHTSTICK_TOUCH = 372, INPUT_ACTION_ORIGIN_STEAMDECK_L4 = 373,
			INPUT_ACTION_ORIGIN_STEAMDECK_R4 = 374, INPUT_ACTION_ORIGIN_STEAMDECK_L5 = 375, INPUT_ACTION_ORIGIN_STEAMDECK_R5 = 376, INPUT_ACTION_ORIGIN_STEAMDECK_DPAD_MOVE = 377, INPUT_ACTION_ORIGIN_STEAMDECK_DPAD_NORTH = 378, INPUT_ACTION_ORIGIN_STEAMDECK_DPAD_SOUTH = 379, INPUT_ACTION_ORIGIN_STEAMDECK_DPAD_WEST = 380, INPUT_ACTION_ORIGIN_STEAMDECK_DPAD_EAST = 381,
			INPUT_ACTION_ORIGIN_STEAMDECK_GYRO_MOVE = 382, INPUT_ACTION_ORIGIN_STEAMDECK_GYRO_PITCH = 383, INPUT_ACTION_ORIGIN_STEAMDECK_GYRO_YAW = 384, INPUT_ACTION_ORIGIN_STEAMDECK_GYRO_ROLL = 385, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED1 = 386, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED2 = 387, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED3 = 388,
			INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED4 = 389, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED5 = 390, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED6 = 391, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED7 = 392, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED8 = 393, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED9 = 394, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED10 = 395,
			INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED11 = 396, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED12 = 397, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED13 = 398, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED14 = 399, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED15 = 400, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED16 = 401, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED17 = 402,
			INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED18 = 403, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED19 = 404, INPUT_ACTION_ORIGIN_STEAMDECK_RESERVED20 = 405, INPUT_ACTION_ORIGIN_COUNT = 406, INPUT_ACTION_ORIGIN_MAXIMUMPOSSIBLEVALUE = 32767
		};
		enum SteamInputType {
		...
		enum ParentalFeature {
			FEATURE_INVALID = 0, FEATURE_STORE = 1, FEATURE_COMMUNITY = 2, FEATURE_PROFILE = 3, FEATURE_FRIENDS = 4, FEATURE_NEWS = 5, FEATURE_TRADING = 6, FEATURE_SETTINGS = 7, FEATURE_CONSOLE = 8, FEATURE_BROWSER = 9, FEATURE_PARENTAL_SETUP = 10, FEATURE_LIBRARY = 11, FEATURE_TEST = 12, FEATURE_SITE_LICENSE = 13, FEATURE_KIOSK_MODE = 14, FEATURE_MAX
		};
		...
		enum UGCContentDescriptorID {
			UGCCONTENTDESCRIPTOR_NUDITY_OR_SEXUAL_CONTENT = 1, UGCCONTENTDESCRIPTOR_FREQUENT_VIOLENCE_OR_GORE = 2, UGCCONTENTDESCRIPTOR_ADULT_ONLY_SEXUAL_CONTENT = 3, UGCCONTENTDESCRIPTOR_GRATUITOUS_SEXUAL_CONTENT = 4, UGCCONTENTDESCRIPTOR_ANY_MATURE_CONTENT = 5
		};
...
//		bool setConfigValue(NetworkingConfigValue setting, NetworkingConfigScope scope_type, uint32_t connection_handle, NetworkingConfigDataType data_type, auto value);
		...
		void createBeacon(uint32 open_slots, uint64_t location, SteamPartyBeaconLocationType type, const String& connect_string, const String& metadata);
