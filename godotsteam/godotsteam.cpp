...
void Steam::_global_stats_received(GlobalStatsReceived_t* callData){
...
void Steam::_leaderboard_ugc_set(LeaderboardUGCSet_t* callData){
	leaderboardHandle = callData->m_hSteamLeaderboard;
	String result;
	if(callData->m_eResult == k_EResultOK){
		result = "ok";
...
void Steam::_bind_methods(){
	...
	ObjectTypeDB::bind_method("getInputTypeForHandle", &Steam::getInputTypeForHandle);
	...
	ObjectTypeDB::bind_method("setLinkedLobby", &Steam::setLinkedLobby);
...
//	ObjectTypeDB::bind_method("setItemTags", &Steam::setItemTags);
	...
	ObjectTypeDB::bind_method(_MD("setLeaderboardDetailsMax", "details_max"), &Steam::setLeaderboardDetailsMax);
	...
	// Utils Bind Methods ///////////////////////
	ObjectTypeDB::bind_method("overlayNeedsPresent", &Steam::overlayNeedsPresent);
	...
	ObjectTypeDB::bind_method("getIPCCallCount", &Steam::getIPCCallCount);
	...
	ObjectTypeDB::bind_method("getSecondsSinceComputerActive", &Steam::getSecondsSinceComputerActive);
	...
	ObjectTypeDB::bind_method("isVRHeadsetStreamingEnabled", &Steam::isVRHeadsetStreamingEnabled);
	ObjectTypeDB::bind_method("setOverlayNotificationInset", &Steam::setOverlayNotificationInset);
	ObjectTypeDB::bind_method(_MD("setOverlayNotificationPosition", "pos"), &Steam::setOverlayNotificationPosition);
	ObjectTypeDB::bind_method("setVRHeadsetStreamingEnabled", &Steam::setVRHeadsetStreamingEnabled);
	ObjectTypeDB::bind_method("showGamepadTextInput", &Steam::showGamepadTextInput);
